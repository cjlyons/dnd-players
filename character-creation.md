...
- See [these examples](#examples-character-class-subclass-species--origin) for suggestions on the character choices that align with each type.
  - [Healers](#healers)
  - [Fighters](#fighters)
  - [Spellcasters](#spellcasters)
  - [Thieves](#thieves)

| Type        | Description                                                 | Class options                                                                                  |
| ----------- | ----------------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
...
## Examples: Character class, subclass, species, & origin
